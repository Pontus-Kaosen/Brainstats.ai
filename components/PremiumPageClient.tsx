...
export default function PremiumPageClient({ trustData }: PremiumPageClientProps) {
  const { t } = useLanguage();
  ...
  async function startCheckout(plan: PaidPlan) {
    ...
    try {
      ...
      if (!session?.user) {
        trackEvent("checkout_login_redirect", { plan });
    ...
    <main className="relative min-h-screen overflow-x-hidden brain-page">
      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-8 sm:py-16">
          ...
          <PremiumTrustSection
            valueBetStats={trustData.valueBetStats}
            valueBetEntries={trustData.valueBetEntries}
            analysisHitRate={trustData.analysisHitRate}
            analysisResolved={trustData.analysisResolved}
          />
