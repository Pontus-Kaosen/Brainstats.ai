...
export const translations = {
  sv: {
    ...
    profile: {
      badge: "Personlig profil",
      title: "Din analysprofil",
      description:
        "Här följer du vad du har analyserat: volym, BrainScore, riskmix, marknader och historik.",
      lockedDescription:
        "Profilen och den djupa analysstatistiken ingår i Pro och Elite.",
      loading: "Hämtar din profil...",
      loadErrorTitle: "Profilen kunde inte laddas",
      loadErrorDefault: "Profilen kunde inte laddas.",
      memberSince: "Medlem sedan {date}",
      lockedBadge: "Pro & Elite",
      lockedTitle: "Lås upp din analysprofil",
      lockedText:
        "Betalande medlemmar får en riktig profil med statistik på allt de analyserat — inte bara de senaste raderna i dashboarden.",
      lockPointStats: "Snitt-BrainScore, veckovolym och confidence",
      lockPointHistory: "Full historik med datum, risk och score",
      lockPointTrends: "Riskmix, bedömningar och vanligaste matcher",
      lockedCta: "Uppgradera till Pro",
      statTotal: "Analyser totalt",
      statAverage: "Snitt-BrainScore",
      statWeek: "Senaste 7 dagarna",
      statConfidence: "Snitt-confidence",
      riskMix: "Risk",
      riskTitle: "Hur dina analyser fördelas",
      verdictMix: "Bedömning",
      verdictTitle: "Är det värt att spela?",
      emptyStats: "Kör några analyser så fylls statistiken i.",
      emptyVerdicts: "Bedömningar visas när du kört analyser med worth-betting.",
      activityBadge: "Aktivitet",
      activityTitle: "Analyser per vecka",
      activityHint: "De senaste åtta veckorna.",
      topBadge: "Matcher",
      topMatchesTitle: "Mest analyserade matcher",
      marketsBadge: "Marknader",
      marketsTitle: "Dina vanligaste marknader",
      emptyMarkets: "Marknader fylls i när analyserna har sparad marknadstext.",
      historyBadge: "Historik",
      historyTitle: "Alla dina analyser",
      historyHint: "Visar {count} av {total} sparade analyser.",
    },
    ...
    valueBets: {
      ...
      lockedHint: "Dagens tips är låsta — samma spel hela dagen tills avspark.",
    ...
    valueBetsHistory: {
      ...
      emptySidebar: "Inga tips loggade ännu.",
      emptyHint: "Nya Elite-tips publiceras dagligen. Prova exempelrapporten under tiden.",
      ...
      plans: {
        ...
        pro: {
          ...
          features: [
            ...
            "Sparad historik",
            "Personlig analysprofil & statistik",
            "Djupare rapporter",
          ],
        },
        elite: {
    ...
    analyze: {
      ...
      matchDataSection: "Matchdata & underlag",
      matchDataHint:
        "Väder, startelvor, form, skador och schema — allt Brain Engine använt i analysen.",
      noWeatherData: "Ingen väderdata tillgänglig för den här matchen.",
      noRefereeData: "Domare ej angiven",
      injuriesBadge: "Truppläge",
    ...
    planComparison: {
      ...
      rows: [
        ...
        {
          label: "Personlig analysprofil & statistik",
          free: "—",
          pro: "Ja",
          elite: "Ja",
        },
  ...
  en: {
    ...
    profile: {
      ...
      title: "Your analysis profile",
      description:
        "Follow what you have analyzed: volume, BrainScore, risk mix, markets and history.",
      lockedDescription:
        "The profile and deep analysis stats are included with Pro and Elite.",
      loading: "Loading your profile...",
      loadErrorTitle: "Profile could not be loaded",
      loadErrorDefault: "Profile could not be loaded.",
      memberSince: "Member since {date}",
      lockedBadge: "Pro & Elite",
      lockedTitle: "Unlock your analysis profile",
      lockedText:
        "Paying members get a real profile with stats on everything they have analyzed — not just the latest rows on the dashboard.",
      lockPointStats: "Average BrainScore, weekly volume and confidence",
      lockPointHistory: "Full history with date, risk and score",
      lockPointTrends: "Risk mix, verdicts and most analyzed matches",
      lockedCta: "Upgrade to Pro",
      statTotal: "Analyses total",
      statAverage: "Avg BrainScore",
      statWeek: "Last 7 days",
      statConfidence: "Avg confidence",
      riskMix: "Risk",
      riskTitle: "How your analyses split",
      verdictMix: "Verdict",
      verdictTitle: "Worth playing your idea?",
      emptyStats: "Run a few analyses and the stats will fill in.",
      emptyVerdicts: "Verdicts appear after analyses with worth-betting data.",
      activityBadge: "Activity",
      activityTitle: "Analyses per week",
      activityHint: "The last eight weeks.",
      topBadge: "Matches",
      topMatchesTitle: "Most analyzed matches",
      marketsBadge: "Markets",
      marketsTitle: "Your most common markets",
      emptyMarkets: "Markets fill in when analyses have saved market text.",
      historyBadge: "History",
      historyTitle: "All your analyses",
      historyHint: "Showing {count} of {total} saved analyses.",
    },
    ...
    valueBets: {
      ...
      lockedHint: "Today's picks are locked — same bets all day until kick-off.",
    ...
    valueBetsHistory: {
      ...
      emptySidebar: "No picks logged yet.",
      emptyHint: "New Elite picks publish daily. Try the sample report in the meantime.",
      ...
      plans: {
        ...
        pro: {
          ...
          features: [
            ...
            "3 AI slips per day",
            "Saved history",
            "Personal analysis profile & stats",
            "Deeper reports",
          ],
        },
        elite: {
    ...
    analyze: {
      ...
      matchDataSection: "Match data & inputs",
      matchDataHint:
        "Weather, lineups, form, injuries and schedule — everything Brain Engine used in this analysis.",
      noWeatherData: "No weather data available for this match.",
      noRefereeData: "Referee not listed",
      injuriesBadge: "Squad status",
      brainScore: "/100 BrainScore™",
    ...
    planComparison: {
      ...
      rows: [
        ...
        {
          label: "Personal analysis profile & stats",
          free: "—",
          pro: "Yes",
          elite: "Yes",
        },
